    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'     => array(            
            array(
                'id'       => 'hbutton-1',
                'type'     => 'text',
                'title'    => __('Button One', 'redux-framework-demo'),
                'validate' => 'text'
            ),
            array(
                'id'       => 'hbuton-url1',
                'type'     => 'text',
                'title'    => __('Button Url One', 'redux-framework-demo'),
                'validate' => 'link'
            ),
             array(
                'id'       => 'hbutton-2',
                'type'     => 'text',
                'title'    => __('Button Two', 'redux-framework-demo'),
                'validate' => 'text'
            ),
            array(
                'id'       => 'hbutton-url2',
                'type'     => 'text',
                'title'    => __('Button Url Two', 'redux-framework-demo'),
                'validate' => 'link'
            ),
            array(
                'id'       => 'side-image',
                'type'     => 'media',
                'url'      => true,
                'title'    => __( 'Image/URL', 'redux-framework-demo' ),
                'compiler' => 'true',
            ),
...
//features Section Start
    ...
    //Main features title Section Start
    Redux::setSection( $opt_name, array(
    ...
    //Left Features Section Start
    Redux::setSection( $opt_name, array(
        'title'      => __( 'Left Features', 'redux-framework-demo' ),
        'id'         => 'left-features',
        'desc'       => __( 'For full documentation on this field, visit: ', 'redux-framework-demo' ) . '<a href="//docs.reduxframework.com/core/fields/media/" target="_blank">docs.reduxframework.com/core/fields/media/</a>',
        'subsection' => true,
        'fields'     => array(
           array(
                'id'       => 'title1',
                'type'     => 'text',
                'title'    => __('Title One', 'redux-framework-demo'),
                'validate' => 'text'
            ),
            array(
                'id'       => 'description1',
                'type'     => 'text',
                'title'    => __('Description One', 'redux-framework-demo'),
                'validate' => 'text'
            ),
            array(
                'id'       => 'icon1',
                'type'     => 'text',
                'title'    => __('Icon One', 'redux-framework-demo'),
                'validate' => 'text'
            ),
            array(
                'id'       => 'title2',
                'type'     => 'text',
                'title'    => __('Title Two', 'redux-framework-demo'),
                'validate' => 'text'
            ),
            array(
                'id'       => 'description2',
                'type'     => 'text',
                'title'    => __('Description Two', 'redux-framework-demo'),
                'validate' => 'text'
            ),
            array(
                'id'       => 'icon2',
                'type'     => 'text',
                'title'    => __('Icon Two', 'redux-framework-demo'),
                'validate' => 'text'
            ),
            array(
                'id'       => 'title3',
                'type'     => 'text',
                'title'    => __('Title Three', 'redux-framework-demo'),
                'validate' => 'text'
            ),
            array(
                'id'       => 'description3',
                'type'     => 'text',
                'title'    => __('Description Three', 'redux-framework-demo'),
                'validate' => 'text'
            ),
            array(
                'id'       => 'icon3',
                'type'     => 'text',
                'title'    => __('Icon Three', 'redux-framework-demo'),
                'validate' => 'text'
            ),
        ),
    ) );
//Left Features Section End  

  //Right Features Section Start
    Redux::setSection( $opt_name, array(
        'title'      => __( 'Right Features', 'redux-framework-demo' ),
        'id'         => 'right-features',
        'desc'       => __( 'For full documentation on this field, visit: ', 'redux-framework-demo' ) . '<a href="//docs.reduxframework.com/core/fields/media/" target="_blank">docs.reduxframework.com/core/fields/media/</a>',
        'subsection' => true,
        'fields'     => array(
...
//Right Features Section End 


//Call to action section satrt
...
Redux::setSection( $opt_name, array(
        'title'      => __( 'Footer Social', 'redux-framework-demo' ),
        'id'         => 'opt-social',
        'icon' => 'el el-user',
        'fields'     => array(
