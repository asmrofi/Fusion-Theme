...
if ( ! function_exists( 'fusion_posted_by' ) ) :
	/**
	 * Prints HTML with meta information for the current author.
	 */
	function fusion_posted_by() {
		$byline = sprintf(
			...
			comments_popup_link(
				sprintf(
					wp_kses(
						...
						__( 'Leave a Comment<span class="screen-reader-text"> on %s</span>', 'fusion' ),
						array(
							'span' => array(
								'class' => array(),
							),
		...
		edit_post_link(
			sprintf(
				wp_kses(
					...
					__( 'Edit <span class="screen-reader-text">%s</span>', 'fusion' ),
					array(
						'span' => array(
							'class' => array(),
						),
